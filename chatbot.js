...
(function () {
  ...
  var BIZ = {
    ...
    maps: 'https://www.google.com/maps/search/?api=1&query=Theosophical%20Society%20Complex%2C%20Basaveshwara%20Talkies%20Road%2C%20Chitradurga%20577501',
    proprietor: 'N. Lokesh',
    since: '2001'
  };
  ...
  var UI = {
    en: {
      ...
      brandsList: ['<strong>V-Guard</strong> — authorised channel partner for solar rooftops', '<strong>Exide</strong> — home UPS &amp; batteries', '<strong>Redsun</strong> — solar &amp; heat-pump water heaters', '<strong>Racold</strong> — electric water heaters', '<strong>Zero B</strong> — water softeners &amp; RO purifiers'],
      ...
      hoursText: 'Please give us a call and we\u2019ll confirm the best time to visit \u2014 we\u2019re always happy to help.',
    ...
    kn: {
      ...
      brandsList: ['<strong>V-Guard</strong> — ಸೌರ ರೂಫ್‌ಟಾಪ್‌ಗೆ ಅಧಿಕೃತ ಚಾನೆಲ್ ಪಾಲುದಾರ', '<strong>Exide</strong> — ಹೋಮ್ UPS ಮತ್ತು ಬ್ಯಾಟರಿ', '<strong>Redsun</strong> — ಸೌರ ಮತ್ತು ಹೀಟ್ ಪಂಪ್ ವಾಟರ್ ಹೀಟರ್', '<strong>Racold</strong> — ಎಲೆಕ್ಟ್ರಿಕ್ ವಾಟರ್ ಹೀಟರ್', '<strong>Zero B</strong> — ವಾಟರ್ ಸಾಫ್ಟನರ್ ಮತ್ತು RO'],
      ...
      hoursText: 'ದಯವಿಟ್ಟು ನಮಗೆ ಕರೆ ಮಾಡಿ, ಭೇಟಿಗೆ ಸೂಕ್ತ ಸಮಯವನ್ನು ನಾವು ಖಚಿತಪಡಿಸುತ್ತೇವೆ.',
    ...
    hi: {
      ...
      brandsList: ['<strong>V-Guard</strong> — सोलर रूफटॉप के लिए अधिकृत चैनल पार्टनर', '<strong>Exide</strong> — होम UPS और बैटरी', '<strong>Redsun</strong> — सोलर और हीट पंप वॉटर हीटर', '<strong>Racold</strong> — इलेक्ट्रिक वॉटर हीटर', '<strong>Zero B</strong> — वॉटर सॉफ़्टनर और RO'],
      ...
      hoursText: 'कृपया हमें कॉल करें, हम आने का सही समय बता देंगे — हमें मदद करके खुशी होगी।',
    ...
    te: {
      ...
      brandsList: ['<strong>V-Guard</strong> — సోలార్ రూఫ్‌టాప్‌కు అధీకృత ఛానల్ భాగస్వామి', '<strong>Exide</strong> — హోమ్ UPS &amp; బ్యాటరీలు', '<strong>Redsun</strong> — సోలార్ &amp; హీట్ పంప్ వాటర్ హీటర్లు', '<strong>Racold</strong> — ఎలక్ట్రిక్ వాటర్ హీటర్లు', '<strong>Zero B</strong> — వాటర్ సాఫ్ట్‌నర్ &amp; RO'],
      ...
      hoursText: 'దయచేసి మాకు కాల్ చేయండి, సందర్శనకు సరైన సమయాన్ని మేము నిర్ధారిస్తాము.',
    ...
    ta: {
      ...
      brandsList: ['<strong>V-Guard</strong> — சோலார் ரூஃப்டாப்பிற்கு அங்கீகரிக்கப்பட்ட சேனல் பங்குதாரர்', '<strong>Exide</strong> — ஹோம் UPS &amp; பேட்டரிகள்', '<strong>Redsun</strong> — சோலார் &amp; ஹீட் பம்ப் வாட்டர் ஹீட்டர்கள்', '<strong>Racold</strong> — எலக்ட்ரிக் வாட்டர் ஹீட்டர்கள்', '<strong>Zero B</strong> — வாட்டர் சாஃப்ட்னர் &amp; RO'],
      ...
      hoursText: 'தயவுசெய்து எங்களை அழைக்கவும், வருகைக்கு சரியான நேரத்தை நாங்கள் உறுதிப்படுத்துவோம்.',
